ActionController::Routing::Routes.draw do |map|
  ...
  map.resources :reportes, :member => {:grafica => :get,:grafica_2 => :get,:reporte_xls => :get,:reporte_2_xls => :get}
  ...
  map.root :controller => 'admin', :action => 'inicio' 
