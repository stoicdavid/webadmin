module UsuariosHelper
  ...
  #
  # Takes options
  # * :content_text => 'Content text in place of usuario.login', escaped with
  #   the standard h() function.
  # * :content_method => :usuario_instance_method_to_call_for_content_text
  # * :title_method => :usuario_instance_method_to_call_for_title_attribute
  # * as well as link_to()'s standard options
  #
  # Examples:
  #   link_to_usuario @usuario
  #   # => <a href="/usuarios/3" title="barmy">barmy</a>
  #
  #   # if you've added a .name attribute:
  #  content_tag :span, :class => :vcard do
  #    (link_to_usuario usuario, :class => 'fn n', :title_method => :login, :content_method => :name) +
  #          ': ' + (content_tag :span, usuario.email, :class => 'email')
  #   end
